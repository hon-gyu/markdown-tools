...
| Inlay hints (link direction) | `[[#setup]]↓8` — which way an intra-note link's target is, and how far. | [inlay-hints-link-direction](docs/feature-inlay-hints-link-direction.mld) |
